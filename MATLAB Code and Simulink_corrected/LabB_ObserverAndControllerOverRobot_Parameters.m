...
% 
% % Input
% voltage_values = zeros(length(voltage_out.signals.values),1);
% voltage_times = voltage_out.time(:,1);
% for i = 1:length(voltage_out.signals.values)
%     voltage_values(i,1) = voltage_values(i,1) + voltage_out.signals.values(:,:,i);
% end
% 
% figure(1)
