...
static emlrtRSInfo b_emlrtRSI = { 1,   /* lineNo */
  ...
  "C:\\Users\\jlosi\\OneDrive\\Documenti\\MATLAB\\RASPlib\\blocks\\soMPU6050Accel.m"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance, const emlrtStack *sp);
static soMPU6050Accel *soMPU6050Accel_soMPU6050Accel
  (InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance, soMPU6050Accel *obj);
static void SystemCore_setup(const emlrtStack *sp, soMPU6050Accel *obj);
static void mw__internal__call__reset(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance, const emlrtStack *sp, int16_T *c_y0, int16_T *c_y1, int16_T
  *b_y2);
static const mxArray *emlrt_marshallOut(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_EBrmIeKF42JWzSSn4953bC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_EBrmIeKF42JWzSSn4953bC
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_EBrmIeKF42JWzSSn4953bC
  *moduleInstance);
  ...
  (InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance)
{
  ...
  covrtScriptInit(moduleInstance->covInst_CONTAINER_BLOCK_INDEX,
                  "C:\\Users\\jlosi\\OneDrive\\Documenti\\MATLAB\\RASPlib\\blocks\\soMPU6050Accel.m",
...
/* CGXE Glue Code */
static void mdlOutputs_EBrmIeKF42JWzSSn4953bC(SimStruct *S, int_T tid)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_EBrmIeKF42JWzSSn4953bC(SimStruct *S, int_T tid)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_EBrmIeKF42JWzSSn4953bC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
  InstanceStruct_EBrmIeKF42JWzSSn4953bC *moduleInstance =
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC *)calloc(1, sizeof
    (InstanceStruct_EBrmIeKF42JWzSSn4953bC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_EBrmIeKF42JWzSSn4953bC);
  ssSetmdlInitializeConditions(S, mdlInitialize_EBrmIeKF42JWzSSn4953bC);
  ssSetmdlUpdate(S, mdlUpdate_EBrmIeKF42JWzSSn4953bC);
  ssSetmdlTerminate(S, mdlTerminate_EBrmIeKF42JWzSSn4953bC);
  ssSetmdlEnable(S, mdlEnable_EBrmIeKF42JWzSSn4953bC);
  ssSetmdlDisable(S, mdlDisable_EBrmIeKF42JWzSSn4953bC);
...
static void mdlProcessParameters_EBrmIeKF42JWzSSn4953bC(SimStruct *S)
{
}

void method_dispatcher_EBrmIeKF42JWzSSn4953bC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_EBrmIeKF42JWzSSn4953bC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_EBrmIeKF42JWzSSn4953bC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_EBrmIeKF42JWzSSn4953bC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_EBrmIeKF42JWzSSn4953bC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: EBrmIeKF42JWzSSn4953bC.\n"
...
mxArray *cgxe_EBrmIeKF42JWzSSn4953bC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_EBrmIeKF42JWzSSn4953bC_fallback_info(void)
{
