...
typedef struct {
  ...
  codertarget_arduinobase_interna obj_a;/* '<S55>/PWM' */
  codertarget_arduinobase_interna obj_o;/* '<S54>/PWM' */
  e_codertarget_arduinobase_inter gobj_0;/* '<S55>/PWM' */
  e_codertarget_arduinobase_inter gobj_1;/* '<S55>/PWM' */
  e_codertarget_arduinobase_inter gobj_2;/* '<S55>/PWM' */
  e_codertarget_arduinobase_inter gobj_3;/* '<S55>/PWM' */
  e_codertarget_arduinobase_inter gobj_0_j;/* '<S54>/PWM' */
  e_codertarget_arduinobase_inter gobj_1_a;/* '<S54>/PWM' */
  e_codertarget_arduinobase_inter gobj_2_k;/* '<S54>/PWM' */
  e_codertarget_arduinobase_inter gobj_3_d;/* '<S54>/PWM' */
  Encoder_arduino_LabC_Compensato obj_g;/* '<S3>/Encoder' */
  soMPU6050Gyro_LabC_CompensatorO obj_gi;/* '<S3>/Gyroscope' */
  codertarget_arduinobase_blocks_ obj_c;/* '<S55>/Digital Output1' */
 ...
 * '<S55>'  : 'LabC_CompensatorOverRobot/plant/M1V4 Middle Motor Driver PWM2, D5 FST'
 * '<S56>'  : 'LabC_CompensatorOverRobot/plant/M1V4 Left Motor Driver PWM6, D8 FST/Compare To Zero'
 * '<S57>'  : 'LabC_CompensatorOverRobot/plant/M1V4 Middle Motor Driver PWM2, D5 FST/Compare To Zero'
 */
