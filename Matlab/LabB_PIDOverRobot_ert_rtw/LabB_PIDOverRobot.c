...
void LabB_PIDOverRobot_step(void)
{
   ...
   */
  rtb_SaturationVsupplytoVsuppl_n = (LabB_PIDOverRobot_P.PIDController_P *
    LabB_PIDOverRobot_B.DiscreteTimeIntegratorconvertfr +
  ...
  if (rtb_SaturationVsupplytoVsuppl_n >
    ...
    LabB_PIDOverRobot_B.Saturation = rtb_SaturationVsupplytoVsuppl_n;
  }
   ...
   *  Sum: '<S27>/SumI2'
   */
  rtb_Kb = (LabB_PIDOverRobot_B.Saturation - rtb_SaturationVsupplytoVsuppl_n) *
  ...
  LabB_PIDOverRobot_DWork.Integrator_DSTATE +=
    (LabB_PIDOverRobot_P.PIDController_I *
     LabB_PIDOverRobot_B.DiscreteTimeIntegratorconvertfr + rtb_Kb) *
...
void LabB_PIDOverRobot_initialize(void)
{
  ...
  /* External mode info */
  LabB_PIDOverRobot_M->Sizes.checksums[0] = (3470046587U);
  LabB_PIDOverRobot_M->Sizes.checksums[1] = (952185190U);
  LabB_PIDOverRobot_M->Sizes.checksums[2] = (1172757615U);
  LabB_PIDOverRobot_M->Sizes.checksums[3] = (3260749543U);
